...
grid.arrange( ggplot(aes(x=alcohol),data=pf[2:13]) +
  ...
  geom_boxplot( ), nrow =1)
summary(pf[2:13]$alcohol)
qplot(x = alcohol, data = pf[2:13], binwidth = 0.1, geom = "freqpoly")
...
grid.arrange( ggplot(aes(x=fixed.acidity),data=pf[2:13]) +
  geom_histogram( binwidth=0.1) + ggtitle("Histogram of fixed acidity (g/dm^3)"), ggplot(aes(x=1, y=fixed.acidity),data=pf[2:13]) +
  geom_boxplot( ), nrow =1)
...
qplot(x = citric.acid, data = pf[2:13], binwidth = 0.01, geom = "freqpoly")
...
qplot(x = density, data = pf[2:13], binwidth = 0.0001, geom = "freqpoly")
...
grid.arrange( ggplot(aes(x=sulphates),data=pf[2:13]) +
  geom_histogram( binwidth=0.01) + ggtitle("Histogram of sulphates (g/dm^3)"), ggplot(aes(x=1, y=sulphates),data=pf[2:13]) +
  geom_boxplot( ), nrow =1)
...
grid.arrange( ggplot(aes(x=pH),data=pf[2:13]) +
  geom_histogram( binwidth=0.01) + ggtitle("Histogram of pH"), ggplot(aes(x=1, y=pH),data=pf[2:13]) +
  geom_boxplot( ), nrow =1)
summary(pf[2:13]$pH)
qplot(x = pH, data = pf[2:13], binwidth = 0.01, geom = "freqpoly")
...
ggcorr(pf[2:13], nbreaks = 4, palette = "RdGy", label = TRUE, label_size = 3, label_color = "white")
...
ggplot(aes(x= total.sulfur.dioxide, y = free.sulfur.dioxide) , data = pf[2:13]) + geom_point(alpha = 0.3, size = 1) + geom_smooth(method = "lm", se = FALSE,size=1) +
  scale_color_brewer(type='seq',
                   guide=guide_legend(title='Quality'))

ggplot(aes(x= fixed.acidity, y = density) , data = pf[2:13]) + geom_point(alpha = 0.3, size = 1) + geom_smooth(method = "lm", se = FALSE,size=1) +
  scale_color_brewer(type='seq',
                   guide=guide_legend(title='Quality'))

ggplot(aes(x= fixed.acidity, y = citric.acid) , data = pf[2:13]) + geom_point(alpha = 0.3, size = 1) + geom_smooth(method = "lm", se = FALSE,size=1) +
  scale_color_brewer(type='seq',
                   guide=guide_legend(title='Quality'))

ggplot(aes(x= pH, y = fixed.acidity) , data = pf[2:13]) + geom_point(alpha = 0.3, size = 1) + geom_smooth(method = "lm", se = FALSE,size=1)+
  scale_color_brewer(type='seq',
                   guide=guide_legend(title='Quality')) 
