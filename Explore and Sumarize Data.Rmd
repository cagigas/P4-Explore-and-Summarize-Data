...
grid.arrange( ggplot(aes(x=alcohol),data=pf) +
  ...
  geom_boxplot( ), nrow =1)
summary(pf$alcohol)
qplot(x = alcohol, data = pf, binwidth = 0.1, geom = "freqpoly")
...
qplot(x = total.sulfur.dioxide, data = pf, binwidth = 1, geom = "freqpoly")
...
qplot(x = fixed.acidity, data = pf, binwidth = 0.1, geom = "freqpoly")
...
qplot(x = volatile.acidity, data = pf, binwidth = 0.01, geom = "freqpoly")
...
qplot(x = citric.acid, data = pf, binwidth = 0.01, geom = "freqpoly")
...
qplot(x = residual.sugar, data = pf, binwidth = 0.1, geom = "freqpoly") +
  coord_cartesian(xlim = c(1,5))
...
qplot(x = chlorides, data = pf, binwidth = 0.005, geom = "freqpoly") +
  coord_cartesian(xlim = c(0,0.2))
...
qplot(x = free.sulfur.dioxide, data = pf, binwidth = 1, geom = "freqpoly")
...
grid.arrange( ggplot(aes(x=density),data=pf) +
  ...
  geom_boxplot( ), nrow =1)
summary(pf$density)
qplot(x = density, data = pf, binwidth = 0.0001, geom = "freqpoly")
...
qplot(x = sulphates, data = pf, binwidth = 0.01, geom = "freqpoly") +
  coord_cartesian(xlim = c(0,1.5))
...
grid.arrange( ggplot(aes(x=pH),data=pf) +
  ...
  geom_boxplot( ), nrow =1)
summary(pf$pH)
qplot(x = pH, data = pf, binwidth = 0.01, geom = "freqpoly")
